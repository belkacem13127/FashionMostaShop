...
<div class="panel-heading"> 
	...
	<i class="fa fa-money fa-fw"></i>&emsp;Ajouter un Lot </h3>
...
<div class="col-md-6" >
	...
	<input type="submit" name="submit" value="Ajouter un Lot" class="btn btn-primary form-control" >
...
if($run_product){
	...
	echo "<script>alert('Lot ajouté !')</script>";
