...
<div class="panel-heading"> 
	...
	<i class="fa fa-money fa-fw"></i>&emsp;Editer le Lot </h3>
...
<div class="form-group" > 
	...
	<label class="col-md-3 control-label" > Lot Url </label>
...
<div class="col-md-6" >
	...
	<input type="submit" name="update" value="Mise à Jour du Lot" class="btn btn-primary form-control" >
