...
?>
	...
	<h1 class="text-center"> Mode de Paiement </h1>

	<p class="lead text-center">
	<a href="order.php?c_id=<?php echo $customer_id; ?>"> Paiement Hors Ligne </a></p>
	...
	<center>
  	...
  	<input type="image" src="https://www.paypalobjects.com/FR/i/btn/btn_buynow_LG.gif" border="0" 
  	name="submit" alt="PayPal - La Sécurité du Paiement en Ligne !">
  
  	<img alt="" border="0" src="https://www.paypalobjects.com/FR/i/scr/pixel.gif" width="1" height="1">
