...
<div class="panel-heading">
	...
	<i class="fa fa-money fa-fw"></i>&emsp;Editer les Conditions </h3> 
...
<div class="col-md-6"> 
	...
	<input type="submit" name="update" value="Mise à Jour des Conditions" class="btn btn-primary form-control" >
...
if(isset($_POST['update'])){
	...
	$update_term = "UPDATE terms set term_title='$term_title',term_link='$term_link',
	term_desc='$term_desc' where term_id='$term_id'";
