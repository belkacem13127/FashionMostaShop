...
<!DOCTYPE html>
	...
	<title> Editer les Articles </title>
...
<div class="panel-heading"> 
	...
	<i class="fa fa-money fa-fw"></i>&emsp;Editer les Articles </h3>
...
<div class="form-group" > 
	...
	<label class="col-md-3 control-label" > Articlet Url </label>
...
<div class="form-group" > 
	...
	<label class="col-md-3 control-label" > Sélectionner un Fournisseur </label>
...
<br>
	...
	<img src="product_images/<?php echo $p_image1; ?>" width="100" height="100" >
...
<br>
	...
	<img src="product_images/<?php echo $p_image2; ?>" width="100" height="100" >
...
<br>
	...
	<img src="product_images/<?php echo $p_image3; ?>" width="100" height="100" >
...
<div class="col-md-6" >
	...
	required value="<?php echo $p_keywords; ?>" >
...
<div class="col-md-6" >
	...
	<input type="submit" name="update" value="Mise à Jour de l'Article" class="btn btn-primary form-control" >
...
if(empty($product_img3)){
	...
	manufacturer_id='$manufacturer_id',date=NOW(),product_title='$product_title',
	product_url='$product_url',product_img1='$product_img1',product_img2='$product_img2',
	product_img3='$product_img3',product_price='$product_price',product_psp_price='$psp_price',
