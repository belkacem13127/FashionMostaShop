...
$db = mysqli_connect("localhost","root","","kacem_db");
...
function getPro(){
	...
	echo "
		...
		<div class='product' > <a href='$pro_url' >
		...
		<p class='buttons' ><a href='$pro_url' class='btn btn-success' >Afficher les détails</a>
		<a href='$pro_url' class='btn btn-danger'>
		<i class='fa fa-shopping-cart'></i> Ajouter au Panier</a> </p></div>$product_label
		</div></div> ";
	}
	}
...
function getProducts(){
	...
	echo "
		...
		<p class='price' > $product_price $product_psp_price </p>
		<p class='buttons' >
		<a href='$pro_url' class='btn btn-success' >Afficher les détails</a>
		<a href='$pro_url' class='btn btn-danger'>
		<i class='fa fa-shopping-cart' data-price=$pro_price></i> Ajouter au Panier</a>
		</p></div> $product_label </div></div> ";
	}
	}
